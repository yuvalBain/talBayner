  ...
  return (
    <>
      <header
        ...
        className={cn(
          className,
          "direction-ltr sticky top-0 z-30 flex min-h-nav w-full items-center border-b border-nav-primary bg-nav-primary transition-shadow duration-200 py-3  px-4"
        )}
        {...props}
      >
        <nav
